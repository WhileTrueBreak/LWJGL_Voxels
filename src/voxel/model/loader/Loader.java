...
import voxel.model.RawModel;
import voxel.model.TextureData;
...
public class Loader {
	...
	public int loadTexture(String path) {
		...
		ByteBuffer texture = ByteBuffer.wrap(new byte[0]);
		...
		try (MemoryStack stack = MemoryStack.stackPush()) {
			...
			texture = STBImage.stbi_load("res/textures/"+path+".png", w, h, comp, 4);
			if (texture == null) {
			...
			e.printStackTrace();
			System.err.println("Failed to load texture "+path+".png");
			System.exit(-1);
		}
